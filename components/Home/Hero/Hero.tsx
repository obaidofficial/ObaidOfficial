...
const Hero = () => {
  return (
    <div className="relative w-full md:h-[70vh] h-[98vh] sm:h-screen bg-[url('/images/hero/heroLight.webp')] dark:bg-[url('/images/hero/heroDark.webp')] bg-cover bg-no-repeat bg-center">
      {/* Overlay */}
