...
const Hero = () => {
  return (
    <div className="relative w-full h-[70vh] sm:h-screen">
      {/* Overlay */}
      <div className="absolute top-0 left-0 w-full h-full bg-cover bg-bottom bg-no-repeat bg-[url('/images/hero/hero-bg.webp')] z-1 opacity-10"></div>
      ...
      <div className="absolute z-100 w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex items-center justify-center flex-col w-full h-full">
          <div className="md:w-[88%] w-[92%]">
            <h1 className="text-[28px] mb-4 md:mb-3 lg:text-[80px] leading-[1.1em] text-black dark:text-white font-normal uppercase">
              Coding the{" "}
            ...
            <p className="text-[14px] mb-4 md:mb-6 w-full lg:w-190 lg:text-[24px] leading-[1.5em] text-black dark:text-white font-light">
