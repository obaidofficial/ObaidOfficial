...
const Hero = () => {
  return (
    <div className="relative w-full md:h-[70vh] h-[88vh] sm:h-screen bg-[url('/images/hero/heroLight.webp')] dark:bg-[url('/images/hero/heroDark.webp')] bg-cover bg-no-repeat bg-center">
      {/* Overlay */}
      ...
      <div className="absolute z-100 w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <div className="flex items-center justify-center flex-col w-full h-full">
          <div className="md:w-325 w-[92%] text-center mx-auto">
            <h1 className="text-[38px] mb-4 md:mb-5 lg:text-[80px] leading-[1.1em] text-[#161616] dark:text-[#fcfcfc] font-medium tracking-[-2px] uppercase">
              Coding the Future
              <br />
