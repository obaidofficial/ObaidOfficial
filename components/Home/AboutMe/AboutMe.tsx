        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-15">
          <div className="lg:col-span-1 p-1 flex flex-col items-left justify-center">
            <h2 className="text-6xl font-medium mb-4 text-[#161616] dark:text-[#fcfcfc] tracking-[-2px]">
              Hi, I am <span className="font-bold uppercase">Obaid Ullah</span>
            </h2>
            <p className="text-[14px] mb-4 md:mb-2 w-full md:text-[18px] leading-[1.5em] text-[#161616] dark:text-[#fcfcfc] font-thin">
            ...
            <p className="text-[14px] mb-4 md:mb-7 w-full md:text-[18px] leading-[1.5em] text-[#161616] dark:text-[#fcfcfc] font-thin">
